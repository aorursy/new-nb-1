...
plt.show()
sns.countplot(x=_______ , data=______ )
plt.figure(figsize=(__,__))
sns.countplot(x="________", data=orders, color='___')
plt.ylabel('________', fontsize=10)
plt.xlabel('______', fontsize=10)
plt.title("____________", fontsize=15)
plt.show()
orders_first = _____________
orders_first.head()
orders_second = _______________
orders_second.head()
...
sns.countplot(ax=axes[____], x=_________, data=_________, color='red')
sns.countplot(ax=axes[____], x=_________, data=_________, color='red')
