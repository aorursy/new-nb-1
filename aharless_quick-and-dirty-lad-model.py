...
#   N-GarPoolAC
static_features = ['taxamount','structuretaxvaluedollarcnt',
...
features = static_features + ['cos_t', 'sin_t']
...
impute_nas(train[select_2016].copy(), test_df, static_features)
y_preds = []
...
output.head()
output.to_csv('lad2016.csv', index=False)
features