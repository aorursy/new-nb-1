...
train.head()
train_2 = pd.read_csv('../input/train_2.csv')
train_2.head()
key_1 = pd.read_csv("../input/key_1.csv")
key_2 = pd.read_csv("../input/key_2.csv")
key_1.head()
key_2.head()
train.columns
train_2.columns
...
#train.Page
train[train.lang=='en'].shape
train[train.lang=='en'].iloc[:,0:-1].shape
train[train.lang=='en'].iloc[:,-1].head()
lang_sets = {}
...
(lang_sets[key].iloc[:,1:].sum(axis=0) / lang_sets[key].shape[0]).head()
(lang_sets[key].iloc[:,1:].sum(axis=0)).head()
for key in lang_sets:
