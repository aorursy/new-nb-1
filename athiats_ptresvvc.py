...
df['target'].value_counts().plot(kind = 'pie', labels = ['Sinceras', 'Toxicas '],autopct='%1.0f%%')
...
test_df['prediction'].value_counts().plot(kind = 'pie', labels = ['Sinceras', 'Toxicas '], autopct='%1.0f%%')