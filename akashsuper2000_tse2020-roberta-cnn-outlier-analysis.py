...
train_outlier1[['sentiment', 'start', 'end', 'start_pred', 'end_pred', 'len_text', 'len_selected_text', 'metric']].hist(ax=ax)
...
train_outlier2[['sentiment', 'start', 'end', 'start_pred', 'end_pred', 'len_text', 'len_selected_text', 'metric']].hist(ax=ax)
...
train_outlier3[['sentiment', 'start', 'end', 'start_pred', 'end_pred', 'len_text', 'len_selected_text', 'metric']].hist(ax=ax)
...
train_outlier5[['sentiment', 'start', 'end', 'start_pred', 'end_pred', 'len_text', 'len_selected_text', 'metric']].hist(ax=ax)
...
train_outlier8[['sentiment', 'start', 'end', 'start_pred', 'end_pred', 'len_text', 'len_selected_text', 'metric']].hist(ax=ax)
