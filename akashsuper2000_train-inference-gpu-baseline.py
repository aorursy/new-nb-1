...
# file.close()
checkpoint = torch.load('../input/alaska2-public-baseline/best-checkpoint-023epoch.bin')
...
submission.head()
sub_stack = pd.read_csv('/kaggle/input/alaska-stacking-files/stack_minmax_mean.csv')
