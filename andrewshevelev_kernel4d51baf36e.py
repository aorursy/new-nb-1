...
# Thanks for https://www.kaggle.com/andrewshevelev/covid-19-lightgbm-with-weather-2
...
day_before_valid = 85 # 3-18 day  before of validation

day_before_public = 85 + 7 # 3-25, the day before public LB period
