...
# model = load_model("/kaggle/input/global-wheat-detection-yolo-darknet-weights/global-wheat-yolo3-darknet53.params", ctx=context)

model = load_model("/kaggle/input/yolo3-darknet-weights/global-wheat-yolo3-darknet53.params", ctx=context)
