...
FIRST_DAY = 400 # If you want to load all the data set it to '1' -->  Great  memory overflow  risk !
...
train_inds = X_train.index.values
...
# pd.DataFrame(fake_valid_data.data)
# df
...
m_lgb = lgb.Booster(model_file='/kaggle/input/m5-accuracy-submission-file/model.lgb')
