...
# Thanks for https://www.kaggle.com/osciiart/covid-19-lightgbm-no-leak
...
df_traintest.head()
df_traintest.day.max()
df_traintest.day.hist()
# day_before_valid = 71 # 3-11 day  before of validation

# day_before_public = 78 # 3-18 last day of train

day_before_valid = 71 + 7 # 3-11 day  before of validation

day_before_public = 78 +7 # 3-18 last day of train
...
day_before_launch = 85 + 7# 4-1 last day before launch
