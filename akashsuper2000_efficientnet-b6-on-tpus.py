...
model_B6.load_weights('/kaggle/input/melanoma-weights/enetb6.h5')

print("\n Done Training model_B6 \n")



model_B6.save_weights('enetb6.h5')
...
submission.to_csv(f'submission_ensemble.csv', index=False)
...
# submission.to_csv(f'submission_EfficientNet_B6.csv', index=False)
...
# submission.to_csv(f'submission_EfficientNet_B7.csv', index=False)
