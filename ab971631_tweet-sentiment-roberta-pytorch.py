...
class TweetDataset(torch.utils.data.Dataset):
    ...
    def get_input_data(self, row):
        ...
        # roberta expect sentence start with space
        ...
        # 0 = <s>, 1 = <pad>, 2 = </s>, 3 = <unk> in ByteLevelBPETokenizer vocab

        ids = [0] + sentiment_id + [2, 2] + encoding.ids + [2]

        masks=[1, 1, 1, 1] + encoding.attention_mask + [1]

        offsets = [(0, 0)] * 4 + encoding.offsets + [(0, 0)]

        token_type_ids=[0, 0, 0, 0] + encoding.type_ids + [0]
