...
df_pred_q05 = pd.DataFrame({"ForecastId_Quantile": ids_all + "_0.05", "TargetValue": 0.8 * pred_all})

df_pred_q50 = pd.DataFrame({"ForecastId_Quantile": ids_all + "_0.5", "TargetValue": pred_all})

df_pred_q95 = pd.DataFrame({"ForecastId_Quantile": ids_all + "_0.95", "TargetValue": 1.2 * pred_all})
