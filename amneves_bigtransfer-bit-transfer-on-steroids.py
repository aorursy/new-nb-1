...
BALANCE_DATA = False # Will calculate class weigths from sklearn before training
if DEVICE == 'TPU':
...
def plot_train_hist(hist):
    ...
    plt.show()
class BiTModelTransfer(tf.keras.Model):
...
model = BiTModelTransfer(num_classes=1, module=module)
