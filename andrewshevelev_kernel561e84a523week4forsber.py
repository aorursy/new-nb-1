...
df_traintest.head()
# day_before_valid = 71 # 03-11 day  before of validation week 2

# day_before_public = 78 # 03-18 last day of train

# day_before_valid = 71 + 7 # 03-18 day  before of validation week 3

# day_before_public = 78 + 7 # 03-25 last day of train

day_before_valid = 71 + 7 + 7 # 03-25 day  before of validation week 4

day_before_public = 78 + 7 + 7 # 04-01 last day of train
...
# day_before_valid = 71 # 3-11 day  before of validation week 2
...
# day_before_valid = 71 + 7 # 3-18 day  before of validation week 3
...
day_before_valid = 71 + 7 + 7 # 3-22 day  before of validation week4

day_before_public = 78 + 7 + 7 # 3-29 last day of train

day_before_launch = 85 + 7 + 7 # 4-12 last day before launch
